...
const TEAM = [
  {
    id: "Mrs.Tanvi Patil",
    name: "Mrs.Tanvi Patil",
    role: "Campus-Level Faculty Coordinator",
    photo: "https://i.postimg.cc/gk5HkL6p/tanvi-maam.jpg",
    avatar: "https://i.postimg.cc/gk5HkL6p/tanvi-maam.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Mrs.Priyanka Kamble",
    name: "Mrs.Priyanka Kamble",
    role: "Departmental Level Faculty Coordinator",
    photo: "https://i.postimg.cc/mk9CP89G/priyanka-maam.jpg",
    avatar: "https://i.postimg.cc/mk9CP89G/priyanka-maam.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
]
  ...
  return (
    ...
    <section aria-label="Team">
      ...
      <header className="mb-8 text-center md:mb-12">
        <h1 className="text-balance mt-3 text-4xl font-extrabold text-white md:text-6xl font-archivo">FACULTY COORDINATORS</h1>
        <p className="text-pretty mx-auto mt-4 max-w-2xl text-base text-white/70 md:text-lg">
       The Faculty Coordinator guides CSI SJCEM with mentorship, leadership, and support, ensuring collaboration between students and faculty while fostering innovation and growth.
        </p>
      </header>
      ...
      <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
        {TEAM.map((m) => (
