...
const TEAM = [
  {
    ...
    name: "Rohit Tiwari",
    role: "Advisor",
    photo: "https://i.postimg.cc/KjML99jq/rohit.jpg",
    avatar: "https://i.postimg.cc/KjML99jq/rohit.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Amit Tripathi",
    name: "Amit Tripathi",
    avatar: "https://i.postimg.cc/L5p6pvv0/amit.jpg",
    photo: "https://i.postimg.cc/L5p6pvv0/amit.jpg",
    role: "Advisor",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    ...
    avatar: "https://i.postimg.cc/TwcBK9fs/hitanshu.jpg",
    photo: "https://i.postimg.cc/TwcBK9fs/hitanshu.jpg",
    role: "Advisor",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Durvesh Vinherkar",
    name: "Durvesh Vinherkar",
    avatar: "https://i.postimg.cc/VL04TR2c/durvesh.jpg",
    photo: "https://i.postimg.cc/VL04TR2c/durvesh.jpg",
    role: "Advisor",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
]
  ...
  return (
    ...
    <section aria-label="Team">
      ...
      <header className="mb-8 text-center md:mb-12">
        <h1 className="text-balance mt-3 text-4xl font-extrabold text-white md:text-6xl font-montserrat">BOARD OF ADVISORS</h1>
        <p className="text-pretty mx-auto mt-4 max-w-2xl text-base text-white/70 md:text-lg">
         Board of Advisors at CSI SJCEM includes professors and mentors who guide the committee with insights to ensure academic excellence.
        </p>
      </header>
