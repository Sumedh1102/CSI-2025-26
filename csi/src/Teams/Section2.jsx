...
const TEAM = [
  {
    id: "Janelle Fernandes",
    name: "Janelle Fernandes",
    role: "PR Head",
    photo: "https://i.postimg.cc/h4CCXKpR/jenny.jpg",
    avatar: "https://i.postimg.cc/h4CCXKpR/jenny.jpg",
  ...
  },
  {
    ...
    name: "Lokesh Rane",
    role: "Member",
    photo: "https://i.postimg.cc/pTrF4M8K/lokesh.jpg",
    avatar: "https://i.postimg.cc/pTrF4M8K/lokesh.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Sharvil Patil",
    name: "Sharvil Patil",
    role: "Member",
    photo: "https://i.postimg.cc/WpQ5G5L5/sharvil.jpg",
    avatar: "https://i.postimg.cc/WpQ5G5L5/sharvil.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Krish Tiwari",
    name: "Krish Tiwari",
    role: "Member",
    photo: "https://i.postimg.cc/8PShk9Vg/pr1.jpg",
    avatar: "https://i.postimg.cc/8PShk9Vg/pr1.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Kajal Rai",
    name: "Kajal Rai",
    role: "Member",
    photo: "https://i.postimg.cc/7hyT6Gdn/kajal.jpg",
    avatar: "https://i.postimg.cc/7hyT6Gdn/kajal.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
   {
    id: "Vaishnavi khandagale",
    name: "Vaishnavi khandagale",
    role: "Member",
    photo: "https://i.postimg.cc/qM43HK8k/pr.jpg",
    avatar: "https://i.postimg.cc/qM43HK8k/pr.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
]
  ...
  return (
    ...
    <section aria-label="Team">
      ...
      <header className="mb-8 text-center md:mb-12">
        <h1 className="text-balance mt-3 text-4xl font-extrabold text-white md:text-6xl font-montserrat">PUBLIC RELATION TEAM</h1>
        <p className="text-pretty mx-auto mt-4 max-w-2xl text-base text-white/70 md:text-lg">
         The PR Team builds connections, manages outreach, and ensures effective communication of the committee’s vision.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 items-stretch gap-3 md:grid-cols-2">
        ...
        <div className="rounded-[20px] bg-[color:var(--dark)] p-8 md:p-10" style={{ "--dark": COLORS.dark }}>
          ...
          <p
            className="mt-4 text-center text-sm font-medium uppercase tracking-wider text-[color:var(--neon)] font-montserrat"
            style={{ "--neon": COLORS.neon }}
          >
            {active.role}
          </p>
      ...
      <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6">
        {TEAM.map((m) => (
