...
const TEAM = [
  {
    ...
    name: "Sumedh Patil",
    role: "Tech Head",
    photo: "https://i.postimg.cc/8Pj617Hz/sumedh.jpg",
    avatar: "https://i.postimg.cc/8Pj617Hz/sumedh.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Swara Patil",
    name: "Swara Patil",
    avatar: "https://i.postimg.cc/Cxbd1kfS/swara.jpg",
    photo: "https://i.postimg.cc/Cxbd1kfS/swara.jpg",
    role: "Member",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Vidhi Jain",
    name: "Vidhi Jain",
    avatar: "https://i.postimg.cc/Xv8JKW8P/vidhi.jpg",
    photo: "https://i.postimg.cc/Xv8JKW8P/vidhi.jpg",
    role: "Member",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Gauri Potdar",
    name: "Gauri Potdar",
    avatar: "https://i.postimg.cc/sDhg67m7/gauri.jpg",
    photo: "https://i.postimg.cc/sDhg67m7/gauri.jpg",
    role: "Member",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Kshitij Patil",
    name: "Kshitij Patil",
    avatar: "https://i.postimg.cc/QtzjSdWf/kshitij.jpg",
    photo: "https://i.postimg.cc/QtzjSdWf/kshitij.jpg",
    role: "Member",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    ...
    name: "Harsh Patil",
    role: "Member",
    photo: "https://i.postimg.cc/PfBw5tFb/sahil.jpg",
    avatar: "https://i.postimg.cc/PfBw5tFb/sahil.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
]
  ...
  return (
    ...
    <section aria-label="Team">
      ...
      <header className="mb-8 text-center md:mb-12">
        <h1 className="text-balance mt-3 text-4xl font-extrabold text-white md:text-6xl font-montserrat">TECHNICAL TEAM</h1>
        <p className="text-pretty mx-auto mt-4 max-w-2xl text-base text-white/70 md:text-lg">
         The Tech Team handles development, technical support, and implements innovative solutions to power every project.
        </p>
      </header>
