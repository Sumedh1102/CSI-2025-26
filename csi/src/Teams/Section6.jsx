...
const TEAM = [
  {
    ...
    name: "Girish Nikose",
    role: "Design Head",
    photo: "https://i.postimg.cc/43KLV4sf/girish.png",
    avatar: "https://i.postimg.cc/43KLV4sf/girish.png",
  ...
  },
  {
    ...
    name: "Sarah Raut",
    role: "Member",
    photo: "https://i.postimg.cc/jqJTtKfr/sara.jpg",
    avatar: "https://i.postimg.cc/jqJTtKfr/sara.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Rhutvi Patil",
    name: "Rhutvi Patil",
    role: "Member",
    photo: "https://i.postimg.cc/hGwY5zpQ/design1.jpg",
    avatar: "https://i.postimg.cc/hGwY5zpQ/design1.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Aarchi Pimple",
    name: "Aarchi Pimple",
    role: "Member",
    photo: "https://i.postimg.cc/SQcPgK8j/design.jpg",
    avatar: "https://i.postimg.cc/SQcPgK8j/design.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Prachi Vishwakarma",
    name: "Prachi Vishwakarma",
    role: "Member",
    photo: "https://i.postimg.cc/Qxbyrnf3/design2.jpg",
    avatar: "https://i.postimg.cc/Qxbyrnf3/design2.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
    {
    id: "Piyush Rao",
    name: "Piyush Rao",
    role: "Member",
    photo: "https://i.postimg.cc/9QQNXtkq/design3.jpg",
    avatar: "https://i.postimg.cc/9QQNXtkq/design3.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
]
  ...
  return (
    ...
    <section aria-label="Team">
      ...
      <header className="mb-8 text-center md:mb-12">
        <h1 className="text-balance mt-3 text-4xl font-extrabold text-white md:text-6xl font-montserrat">DESIGN TEAM</h1>
        <p className="text-pretty mx-auto mt-4 max-w-2xl text-base text-white/70 md:text-lg">
          The Design Team creates graphics, posters, and visuals, blending creativity and design to enhance communication.
        </p>
      </header>
