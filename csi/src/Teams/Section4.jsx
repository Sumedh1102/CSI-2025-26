...
const TEAM = [
  {
    ...
    name: "Aarchi Save",
    role: "Event Head",
    photo: "https://i.postimg.cc/h4Z4spq2/aarchii.jpg",
    avatar: "https://i.postimg.cc/h4Z4spq2/aarchii.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Vikhyat Suvarna",
    name: "Vikhyat Suvarna",
    role: "Member",
    photo: "https://i.postimg.cc/FKvhz6jH/vikhyat.jpg",
    avatar: "https://i.postimg.cc/FKvhz6jH/vikhyat.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Rajendra Singh",
    name: "Rajendra Singh",
    role: "Member",
    photo: "https://i.postimg.cc/qqP9Ytwv/raju.jpg",
    avatar: "https://i.postimg.cc/qqP9Ytwv/raju.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Karan Choudhary",
    ...
    role: "Member",
    photo: "https://i.postimg.cc/02qvc3Bd/karan.jpg",
    avatar: "https://i.postimg.cc/02qvc3Bd/karan.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
  {
    id: "Sharvi Raul",
    name: "Sharvi Raul",
    role: "Member",
    photo: "https://i.postimg.cc/PqcsZFDD/event2.jpg",
    avatar: "https://i.postimg.cc/PqcsZFDD/event2.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
    {
    id: "Parmeet Randhawa",
    name: "Parmeet Randhawa",
    role: "Member",
    photo: "https://i.postimg.cc/8cRq2p0d/event.jpg",
    avatar: "https://i.postimg.cc/8cRq2p0d/event.jpg",
    links: { Linkedin: "#", instagram: "#", Facebook: "#" },
  },
]
  ...
  return (
    ...
    <section aria-label="Team">
      ...
      <header className="mb-8 text-center md:mb-12">
        <h1 className="text-balance mt-3 text-4xl font-extrabold text-white md:text-6xl font-montserrat">EVENT TEAM</h1>
        <p className="text-pretty mx-auto mt-4 max-w-2xl text-base text-white/70 md:text-lg">
          The Event Team plans, organizes, and executes activities, ensuring smooth flow and maximum engagement in all programs.
        </p>
      </header>
